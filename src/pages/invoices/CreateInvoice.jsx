// pages/invoices/CreateInvoice.jsx
...
const CreateInvoice = () => {
  ...
  useEffect(() => {
    document.title = 'Otelex | New Invoice';
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      showToast(res.message || 'Invoice created. Admin must finalize to deduct stock.', 'success');
    ...
    <div className={`main-container theme-${theme}`}>
      ...
      <div className="page-content">
        <PageNav
          ...
          links={[{ label: 'Dashboard', to: '/' }, { label: 'Invoices', to: '/invoices' }, { label: 'New Invoice', active: true }]}
        />

        {/* Admin-only finalize notice */}
        <div className="inv-form-notice">
          <i className="fas fa-circle-info" />
          <span>Invoices are saved as <strong>Draft</strong>. An Admin must <strong>Finalize</strong> the invoice to deduct stock and set it to Sent.</span>
        </div>
        ...
        <div className="qf-layout">
          <div className="qf-main">
            <div className={`qf-card theme-${theme}`}>
              ...
              <div className="qf-field">
                ...
                <div className="qf-client-row">
                  <div className="qf-client-select">
                    <SelectInput options={clientOptions} value={form.client_id} onChange={handleClientChange}
                      placeholder="Select active client..." searchable error={errors.client_id} />
                  </div>
                  {form.client_id && (
                    <button
                      type="button"
                  ...
                  <button type="button" className="qf-new-btn" onClick={() => setClientModalOpen(true)}>
              ...
              <div className="qf-field">
                ...
                <textarea className={`qf-input qf-textarea theme-${theme}`}
                  placeholder="e.g. Please process payment within 7 days..." rows={3}
            ...
            <div className={`qf-card theme-${theme}`}>
              ...
              <LineItemsBuilder items={items} onChange={setItems}
                docDiscountType={form.discount_type} docDiscountValue={form.discount_value}
          ...
          <div className="qf-sidebar">
            <div className={`qf-card qf-sticky theme-${theme}`}>
              ...
              <button className="qf-cancel-link" onClick={() => navigate('/invoices')} type="button">
