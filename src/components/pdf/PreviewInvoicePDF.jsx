...
const PreviewDocumentPDF = ({ doc }) => {
  ...
  // Set Header Title
  const docTitle = isQuotation ? 'QUOTATION #' : (isProforma ? 'PROFORMA INVOICE #' : 'SALES INVOICE #');
  ...
  return (
    <div className='pdf-preview-container'>
      ...
      <div className='pdf-data-flexbox'>
        ...
        <div className='pdf-data-col'>
          <div className='pdf-flex-wrap-two'>
            <p className='pdf-flex-title'>Contact Details</p>
          </div>
          <div className='pdf-flex-wrap-two'>
          ...
          <div className='pdf-flex-wrap-two'>
            <p className='pdf-flex-title-two'>Tel:</p>
